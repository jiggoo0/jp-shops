      ...
      <div className="container relative mx-auto px-4">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1 className="font-heading text-4xl font-extrabold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl xl:text-8xl dark:text-white">
              จัดการทุกเรื่อง{" "}
            ...
            <p className="mt-8 max-w-2xl font-body text-lg leading-relaxed text-slate-700 sm:text-xl dark:text-slate-400">
          ...
          <div className="relative">
            <div className="relative z-10 aspect-square overflow-hidden rounded-[2.5rem] border border-slate-200 bg-slate-50 shadow-2xl dark:border-zinc-800 dark:bg-zinc-900/50">
              <Image
                src="/images/hero/main-hero.webp"
                alt="จัดการเอกสารอย่างมืออาชีพ"
                fill
            ...
            {/* Decorative Elements */}
            <div className="absolute -bottom-10 -left-10 z-20 hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-2xl lg:block dark:border-zinc-800 dark:bg-zinc-950">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary/10 text-secondary">
                  <UserCheck size={24} />
                </div>
                <div>
                  <p className="text-xl font-black italic text-primary">100%</p>
